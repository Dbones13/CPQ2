...
AdjustmentProductivity = Product.Attr('FSC_to_SM_audit_Adjustment_Productivity').GetValue()
fscauditCon = getContainer("MSID_Labor_FSC_to_SM_audit_Con")
...
Product.Attr('FSC_to_SM_audit_Adjustment_Productivity').AssignValue('')
