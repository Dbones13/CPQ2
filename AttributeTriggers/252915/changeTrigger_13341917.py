...
AdjustmentProductivity = Product.Attr('xPM_to_C300_Migration_Adjustment_Productivity').GetValue()
...
if xPMCon.Rows.Count > 0:
    ...
    xPMCon.Calculate()
Product.Attr('xPM_to_C300_Migration_Adjustment_Productivity').AssignValue('')
