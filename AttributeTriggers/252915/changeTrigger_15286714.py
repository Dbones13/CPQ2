...
AdjustmentProductivity = Product.Attr('CD_Actuator_Adjustment_Productivity').GetValue()
...
if CDActuatorCon.Rows.Count > 0:
    ...
    CDActuatorCon.Calculate()
Product.Attr('CD_Actuator_Adjustment_Productivity').AssignValue('')
