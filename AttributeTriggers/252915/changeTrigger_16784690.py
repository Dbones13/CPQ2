...
AdjustmentProductivity = Product.Attr('Generic3_Productivity').GetValue()
if getFloat(AdjustmentProductivity) > 0:
    cbecCon = getContainer("MSID_Labor_Generic_System3_Cont")
    if cbecCon.Rows.Count > 0:
        ...
        cbecCon.Calculate()
    Product.Attr('Generic3_Productivity').AssignValue('')
