...
AdjustmentProductivity = Product.Attr('Generic2_Productivity').GetValue()
if getFloat(AdjustmentProductivity) > 0:
    cbecCon = getContainer("MSID_Labor_Generic_System2_Cont")
    if cbecCon.Rows.Count > 0:
        ...
        cbecCon.Calculate()
    Product.Attr('Generic2_Productivity').AssignValue('')
