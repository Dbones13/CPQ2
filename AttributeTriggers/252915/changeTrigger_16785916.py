...
AdjustmentProductivity = Product.Attr('MSID_Labor_Fsc_SM_IO_Audit_Productivity').GetValue()
fscauditCon = getContainer("MSID_Labor_FSC_to_SM_IO_Audit_Con")
if fscauditCon.Rows.Count > 0:
    for row in fscauditCon.Rows:
    ...
    fscauditCon.Calculate()
Product.Attr('MSID_Labor_Fsc_SM_IO_Audit_Productivity').AssignValue('')
