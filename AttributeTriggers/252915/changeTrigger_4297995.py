...
AdjustmentProductivity = Product.Attr('EHPM_C300PM_Adjustment_Productivity').GetValue()
container = getContainer("MSID_Labor_EHPM_C300PM_Con")
if container.Rows.Count > 0:
    ...
    container.Calculate()
Product.Attr('EHPM_C300PM_Adjustment_Productivity').AssignValue('')
