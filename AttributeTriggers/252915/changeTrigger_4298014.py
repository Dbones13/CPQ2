...
AdjustmentProductivity = Product.Attr('TCMI_Adjustment_Productivity').GetValue()
container = getContainer("MSID_Labor_TCMI_Con")
if container.Rows.Count > 0:
    ...
    container.Calculate()
Product.Attr('TCMI_Adjustment_Productivity').AssignValue('')
