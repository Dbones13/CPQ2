...
AdjustmentProductivity = Product.Attr('C200_Migration_Adjustment_Productivity').GetValue()
...
if c200MigrationCon.Rows.Count > 0:
    ...
    c200MigrationCon.Calculate()
Product.Attr('C200_Migration_Adjustment_Productivity').AssignValue('')
