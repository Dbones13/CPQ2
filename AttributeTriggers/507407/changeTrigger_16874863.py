#Attribute 'FGC_Engineering_Labor_Container' Change Trigger 
...
execCountry = Product.Attr('FGC_Addi_Labor_Execution_Country').GetValue()
updatePrice = 0
...
Product.Attr('FGC_Addi_Labor_Execution_Country').SelectDisplayValue('')