...
FSCtoSMConfiguration = Product.GetContainerByName("FSC_to_SM_Configuration")
NoofConfig = Product.Attr('ATT_FSC_to_SM_Number_of_configurations').GetValue()
newValue = 0 if NoofConfig == '' else int(NoofConfig)
updateContainerTable(Product, FSCtoSMConfiguration, newValue)