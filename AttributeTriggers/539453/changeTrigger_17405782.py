...
if gesLocation <> "None":
    ...
    gesPerc = Product.Attr('HMI_Engineering_Labor_GES_%').GetValue()

    for row in laborRows:
        gesPerc=float(gesPerc)
        excludedDeliverables = ['HMI Operator Interface Workshop', 'HMI Engineering Plan', 'HMI Customer Training']
