...
if gesLocation <> "None":
    ...
    gesPerc = Product.Attr('System_Network_Engineering_Labor_GES_%').GetValue()

    for row in laborRows:
        gesPerc=float(gesPerc)
        excludedDeliverables = ['SNC Customer Training', 'SNC Engineering Plan', 'SNC Network Assessment Report']
...
ScriptExecutor.Execute('system_Network_error_msg2')