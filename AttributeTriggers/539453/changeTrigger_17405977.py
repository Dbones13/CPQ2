...
if gesLocation <> "None":
    ...
    laborRows = Product.GetContainerByName('EBR_Engineering_Labor_Container').Rows


    gesPerc = Product.Attr('EBR_Engineering_Labor_GES_%').GetValue()

    for row in laborRows:
        gesPerc=float(gesPerc)
        excludedDeliverables = ['EBR Procure Materials & Services']
