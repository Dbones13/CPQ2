...
if gesLocation <> "None":
    ...
    gesPerc = Product.Attr('Experion HS GES Engineer %').GetValue()

    for row in laborRows:
        gesPerc=float(gesPerc)
        excludedDeliverables = ['Experion HS Engineering Plan', 'Experion HS Procure Materials & Services', 'Experion HS Customer Training', 'Experion HS Project Close Out Report']
