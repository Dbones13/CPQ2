...
tableLabor = SqlHelper.GetList('select Deliverable,Productivity,GES_Eng_1_No,GES_Eng,FO_Eng_1_NoGES,FO_Eng_1_GES_None,FO_Eng_1_GES,FO_Eng_2_NoGES,FO_Eng_2_GES_None,FO_Eng_2_GES,Rank,Execution_Country from MSC_Labor_Custom_Table')
if laborCont.Rows.Count > 0:
    ...
    laborCont.Calculate()
    contList.append('MSC_Engineering_Labor_Container')
laborCont4 = Product.GetContainerByName('MSC_Additional_Labour_Container')
if laborCont4.Rows.Count > 0:
    ...
    contList.append('MSC_Additional_Labour_Container')
if len(contList) > 0:
