...
laborCont = Product.GetContainerByName('MSE_Engineering_Labor_Container')
tableLabor = SqlHelper.GetList('select Deliverable,Productivity,GES_Eng_1_No,GES_Eng,FO_Eng_1_NoGES,FO_Eng_1_GES_None,FO_Eng_1_GES,FO_Eng_2_NoGES,FO_Eng_2_GES_None,FO_Eng_2_GES,Rank,Execution_Country from MSE_Labor_Custom_Table')
if laborCont.Rows.Count > 0:
    ...
    laborCont.Calculate()
    contList.append('MSE_Engineering_Labor_Container')
laborCont4 = Product.GetContainerByName('MSE_Additional_Labor_Container')
if laborCont4.Rows.Count > 0:
    ...
    contList.append('MSE_Additional_Labor_Container')
if len(contList) > 0:
