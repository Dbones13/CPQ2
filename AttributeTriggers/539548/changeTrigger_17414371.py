...
AdjustmentProductivity = Product.Attr('CB-EC_Upgrade_to_C300-UHIO_Adjustment_Productivity').GetValue()
...
if cbecCon.Rows.Count > 0:
    ...
    cbecCon.Calculate()
Product.Attr('CB-EC_Upgrade_to_C300-UHIO_Adjustment_Productivity').AssignValue('')
