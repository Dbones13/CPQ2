...
AdjustmentProductivity = Product.Attr('FSC_to_SM_Adjustment_Productivity').GetValue()
fsctosmCon = getContainer("MSID_Labor_FSC_to_SM_con")
if fsctosmCon.Rows.Count > 0:
    ...
    fsctosmCon.Calculate()
Product.Attr('FSC_to_SM_Adjustment_Productivity').AssignValue('')
