...
AdjustmentProductivity = Product.Attr('Graphics_Migration_Adjustment_Productivity').GetValue()
...
if GraphicsCon.Rows.Count > 0:
    ...
    GraphicsCon.Calculate()
Product.Attr('Graphics_Migration_Adjustment_Productivity').AssignValue('')
