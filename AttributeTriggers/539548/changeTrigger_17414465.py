...
AdjustmentProductivity = Product.Attr('3rd_Party_PLC_UOC_Labor_Productivity').GetValue()
cbecCon = getContainer("3rd_Party_PLC_UOC_Labor")
if cbecCon.Rows.Count > 0:
    ...
    cbecCon.Calculate()
Product.Attr('3rd_Party_PLC_UOC_Labor_Productivity').AssignValue('')
