...
AdjustmentProductivity = Product.Attr('Generic4_Productivity').GetValue()
if getFloat(AdjustmentProductivity) > 0:
    cbecCon = getContainer("MSID_Labor_Generic_System4_Cont")
    if cbecCon.Rows.Count > 0:
        ...
        cbecCon.Calculate()
    Product.Attr('Generic4_Productivity').AssignValue('')
