...
AdjustmentProductivity = Product.Attr('Generic5_Productivity').GetValue()
if getFloat(AdjustmentProductivity) > 0:
    cbecCon = getContainer("MSID_Labor_Generic_System5_Cont")
    if cbecCon.Rows.Count > 0:
        ...
        cbecCon.Calculate()
    Product.Attr('Generic5_Productivity').AssignValue('')
