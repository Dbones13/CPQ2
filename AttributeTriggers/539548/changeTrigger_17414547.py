...
AdjustmentProductivity = Product.Attr('TPA_Adjustment_Productivity').GetValue()
cbecCon = getContainer("MSID_Labor_TPA_con")
if cbecCon.Rows.Count > 0:
    ...
    cbecCon.Calculate()
Product.Attr('TPA_Adjustment_Productivity').AssignValue('')
