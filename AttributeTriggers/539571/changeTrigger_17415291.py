Product.GetContainerByName('C300_RG_Universal_IO_cont_1').Rows.Clear()
Product.GetContainerByName('C300_RG_Universal_IO_cont_2').Rows.Clear()
Product.GetContainerByName('SerC_RG_Enhanced_Function_IO_Cont').Rows.Clear()
Product.GetContainerByName('SerC_RG_Enhanced_Function_IO_Cont2').Rows.Clear()
Product.GetContainerByName('C300_SerC_Enhanced_Function_IO_Mark_Group_RG_Cont').Rows.Clear()
Product.ResetAttr('SerC_IO_Params')
Product.ResetAttr('Series_C_RG_Part_Summary')
Product.ResetAttr('Series_C_RG_Part_Summary_Cont')
import GS_C300_IO_Calc, GS_Get_Set_AtvQty, GS_SerC_Turbo_IO_Calc
...
if ioFamilyType != 'Series C':
    ...
    "ATTCON_02_open",
    "ATTCON_02_close",
    'Header_02_open','Header_02_close', 'Serc_Environmental Condition']
    for attr in disallow_attrs:
        Product.DisallowAttr(attr)
    #CXCPQ-40833, CXCPQ-40859, CXCPQ-40887 , CXCPQ-41229
...
if ioFamilyType != 'Series-C Mark II':
    ...
    ##GS_C300_IO_Calc.setIOCount(Product, 'SerC_IO_Params', paramDict)
    GS_C300_IO_Calc.setIOCount(Product, 'Series_C_RG_Part_Summary', parts_dict)
    Product.Attr('SerC_RG_Single_Mod_FOE_Type_for_Remote_Grp_Cabinet').SelectValue('Separate IOTA')
if ioFamilyType != 'Turbomachinery':
    ...
    GS_C300_IO_Calc.setIOCount(Product, 'SerC_IO_Params', paramDict)
    GS_C300_IO_Calc.setIOCount(Product, 'Series_C_RG_Part_Summary', parts_dict)
    Product.Attr('SerC_RG_Power_System_Type').SelectValue('Minimum Required Redundant')
    Product.Attr('SerC_RG_Single_Mod_FOE_Type_for_Remote_Grp_Cabinet').SelectValue('Separate IOTA')
...
if ioFamilyType == 'Series C':
    ...
    contList = {'49225': 'SerC_RG_Enhanced_Function_IO_Cont2', '49225_1': 'C300_SerC_GIIS_RG_Cont', '49229':'SerC_RG_Enhanced_Function_IO_Cont' , '49229_1':'C300_SerC_GIIS_RG_Cont'}
    ...
    Product.Attr('SerC_RG_Power_System_Type').SelectValue('Redundant 20A')
    Product.Attr('SerC_RG_Single_Mod_FOE_Type_for_Remote_Grp_Cabinet').SelectValue('Single IOTA')
