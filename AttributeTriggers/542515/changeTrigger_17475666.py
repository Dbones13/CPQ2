...
gesLocation = TagParserProduct.ParseString('Product.Attr("Generic_Ges_Location_Labour").GetValue()')
updateFlag = 0
if gesLocation <> "None":
    laborRows = Product.GetContainerByName('Generic Additional Custom Deliverables').Rows
    gesPerc = Product.Attr('Generic_ACD_GES_%').GetValue()
