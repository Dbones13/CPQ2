var1 = Product.Attr('Number of SMX System RT').GetValue()
var2 = Product.Attr('Number of SMX System ST').GetValue()
Product.Attr('Number of Years of Contract').AssignValue(str(int(var1) + int(var2)))
