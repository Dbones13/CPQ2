...
if Product.Attr('FAT Document Verification and Execution').GetValue() == 'Yes' and Product.Attr('Onsite Support Implementation Services').GetValue() == 'Yes':
    item = SqlHelper.GetFirst("Select PartNumber, Activity,Identifier,Activity_Type,Rank FROM CT_ACTIVITIES where Product = 'MSS' and Identifier = 'A13'")
