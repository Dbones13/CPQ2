...
if Product.Attr('FDS & DDS Documentation Required').GetValue() == '':
    ...
    item = SqlHelper.GetFirst("Select PartNumber, Activity,Identifier,Activity_Type,Rank FROM CT_ACTIVITIES where Product = 'PCN Hardening' and Identifier = 'A8'")
    newRow = activity.AddNewRow(False)
