...
truck = TagParserProduct.ParseString('<* IsSelected(Terminal_Mode_of_Transport.Truck loading/unloading) *>')
rail = TagParserProduct.ParseString('<* IsSelected(Terminal_Mode_of_Transport.Rail Wagon loading/unloading) *>')
pipe = TagParserProduct.ParseString('<* IsSelected(Terminal_Mode_of_Transport.Pipeline loading/unloading) *>')
marine = TagParserProduct.ParseString('<* IsSelected(Terminal_Mode_of_Transport.Marine loading/unloading) *>')
...
if Quote.GetCustomField('isR2QRequest').Content == 'Yes':
    ScriptExecutor.Execute('PS_SetReadOnlyAccess')
