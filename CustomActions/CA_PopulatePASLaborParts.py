...
for Item in Quote.MainItems:
	if ((Item.PartNumber.startswith('HPS_') or Item.PartNumber.startswith('ADV_') or Item.PartNumber.startswith('SVC')) and Item.QI_ProductCostCategory.Value == 'Honeywell Labor') or Item.PartNumber == "SVC-NT-EIT-E-FD-NC" or Item.QI_Winest_Import.Value =='True':
