...
class CL_CompositeRequestReferences():
    ...
    CREATE_BILL_TO_ACC = "Create_Bill_To_Account"
    UPDATE_BILL_TO_ACC = "Update_Bill_To_Account"
    CREATE_BILL_TO_CONTACT = "Create_Bill_To_Contact"
    UPDATE_BILL_TO_CONTACT = "Update_Bill_To_Contact"
    CREATE_SHIP_TO_ACC = "Create_Ship_To_Account"
    UPDATE_SHIP_TO_ACC = "Update_Ship_To_Account"
    CREATE_SHIP_TO_CONTACT = "Create_Ship_To_Contact"
    UPDATE_SHIP_TO_CONTACT = "Update_Ship_To_Contact"
    CREATE_END_USER_ACC = "Create_End_User_Account"
    UPDATE_END_USER_ACC = "Update_End_User_Account"
    CREATE_END_USER_CONTACT = "Create_End_User_Contact"
    UPDATE_END_USER_CONTACT = "Update_End_User_Contact"
    BILL_TO_CONTACT = "BillToContact"
    SHIP_TO_CONTACT = "ShipToContact"
    END_USER_CONTACT = "EndUserContact"
    BILL_TO_CONTACT_ID_REFID = "BillToContact_ID"
    SHIP_TO_CONTACT_ID_REFID = "ShipToContact_ID"
    END_USER_CONTACT_ID_REFID = "EndUserContact_ID"
    ASSIGN_BILL_TO_CONTACT_REFID = "AssignBillToContact"
    ASSIGN_SHIP_TO_CONTACT_REFID = "AssignShipToContact"
    ASSIGN_END_USER_CONTACT_REFID = "AssignEndUserContact"
    ...
    OPP_PARTNER_ROLE_ACC_BILL_TO = "Get_Bill_To_Opportunity_Partner_Role_Account"
    OPP_PARTNER_ROLE_ACC_SHIP_TO = "Get_Ship_To_Opportunity_Partner_Role_Account"
    OPP_PARTNER_ROLE_ACC_END_USER = "Get_End_User_Opportunity_Partner_Role_Account"
