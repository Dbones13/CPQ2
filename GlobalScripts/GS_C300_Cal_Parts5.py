...
class IOComponents:
    ...
    def getrailvalue(self,  questions, columns):
        ...
        if self.Product.Name == "Series-C Control Group":
            container_mapping = {'SCM: LLAI (16) (0-5000)': 'C300_C IO MS2'}
        if self.Product.Name == "Series-C Remote Group":
            container_mapping = {'SCM: LLAI (16) (0-5000)': 'C300_C IO_RG MS2'}
        if len(questions):
            for qn in questions:
                prefix = qn[0:23]
    ...
    def C300_Mark2(self):
        ...
        if self.Product.Name == "Series-C Control Group":
            ...
            if family=="Series-C Mark II":
                ...
                CC32 = self.getrailvalue(['SCM: LLAI (16) (0-5000)'], ['Non_Red_NIS'])
