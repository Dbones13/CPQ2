...
def addValues(totalDict , partNumber,key, value):
    ...
    partDict[key]=round(partDict[key],2)
    ...
    for item in Quote.MainItems:
        if item.PartNumber == "Migration":
            for msid in item.Children:
                ...
                keys_to_replace = ['FDM Upgrade 1', 'FDM Upgrade 2', 'FDM Upgrade 3', 'C200_Migration','Virtualization System','TPS_to_EXP','LCN','LM_ELMM_ControlEdge_PLC','CB_EC_Upgrade_to_C300_UHIO','EHPM_HART_IO']
...
if getCFValue("Quote Type") == "Projects" or getCFValue("Quote Type") == "Parts and Spot" and (getCFValue("Booking LOB") == "LSS" or getCFValue("Booking LOB") == "CCC" or getCFValue("Booking LOB") == "PAS" or getCFValue("Booking LOB") == "PMC") or getCFValue("cyberProductPresent") == "Yes" or getCFValue("Booking LOB") == "HCP":
