...
def getnumberOfjumpRealease(Product):
    Current_Release = getRowData(Product,"MSID_CommonQuestions","MSID_Current_Experion_Release")
    Target_Release = getRowData(Product,"MSID_CommonQuestions","MSID_Future_Experion_Release")
    jump = 0
    a=[]
    Container =Product.GetContainerByName('OPM_Basic_Information')

    for row in Container.Rows:
        Trace.Write (str(row["OPM_Is_this_is_a_Remote_Migration_Service_RMS"]))

        a.append(row["OPM_Is_this_is_a_Remote_Migration_Service_RMS"])
    AMT= str(a[0])
...
def getOrionConsoleLabourHours(Product):
	...
	for key in parameters:
		...
		if key == "Orion_Services":
			...
			var_15 = getRowData(Product,key,parameters[key]["var_15"])
			var_16 = getRowData(Product,key,parameters[key]["var_16"])
			var_17 = getFloat(getRowData(Product,key,parameters[key]["var_17"]))
			var_14 = getRowData(Product,key,parameters[key]["var_14"])
	...
	Trace.Write("selectedDocumentation"+str(selectedDocumentation)+"var_1"+str(var_1)+"var_2"+str(var_2))
...
def getEHPMLabourHours(Quote,Product):
...
def getTPSLabourHours(Product):
	parameters = {"TPS_EX_General_Questions":{"var_1":"IS_Migration_Part_Of_ELCN_Migration","var_34":"Additional_Switches","var_27":"QTY_New_Cabinates","var_41":"Setup_FTE_Network_Infrastructure"},"TPS_EX_Conversion_ESVT_Server":{"var_5":"TPS_EX_TDC_US_ESVT","var_6":"TPS_EX_TDC_AM_ESVT","var_7":"TPS_EX_TDC_APP_ESVT","var_8":"TPS_EX_TDC_GUS_ESVT","var_3_1":"TPS_EX_ESVT_WO_Trade_Ins","var_3_2":"TPS_EX_ESVT_Redundant"},"MSID_CommonQuestions":{"var_32":"MSID_FEL_Data_Gathering_Required","var_31":"MSID_Acceptance_Test_Required","var_30":"MSID_Is_Switch_Configuration_in_Honeywell_Scope"},"TPS_EX_Station_Conversion_EST":{"var_121314":"TPS_EX_Quantity"},"TPS_EX_Additional_Servers":{"var_20":"TPS_EX_Additional_Server_Quantity"},"TPS_EX_Additional_Stations":{"var0":"TPS_EX_Additional_Stations_Quantity"},"TPS_EX_Bundle_Conversion_Server_Stations":{"var_4_1":"TPS_EX_Non_Reduntant_Conversion_ESVT","var_3_1":"TPS_EX_Redundant_Conversion_ESVT"},"TPS_EX_Conversion_ACET_EAPP":{"var9_10":"TPS_EX_Conversion_ACET_EAPP_Qty"},"var_11":"TPS_EX_Need_Domain_Controller_Added","TPS_EX_Monitors":{"var_21_1":"Number_FPD_Lower_Tier_OEP_NON_TS","var_21_2":"Number_FPD_Lower_Tier_OEP_TS","var_21_3":"Number_FPD_Lower_Tier_IKB_Non_TS","var_21_4":"Number_FPD_Lower_Tier_IKB_TS","var_21_5":"Number_FPD_Upper_Tier_Non_TS","var_21_6":"Number_FPD_Lower_Tier_TS","var_22_1":"Desktop_Number_55in_FPD_Non_TS","var_22_2":"Desktop_Number_23in_FPD_Non_TS","var_22_3":"Desktop_Number_22in_FPD_TS","var_22_4":"Desktop_Number_21_3in_FPD_Non_TS","var_22_5":"Desktop_Number_21_3in_FPD_TS","var_26_1":"Z_Console_Number_22in_FPD_Non_TS","var_26_2":"Z_Console_Number_22in_FPS_TS","var_25_1":"EZ_Console_Number_21_3in_FPD_Non_TS","var_25_2":"EZ_Console_Number_21_3in_FPD_TS","var_25_3":"EZ_Console_Number_22in_FPD_NON_TS","var_25_4":"EZ_Console_Number_22in_FPD_TS","var_23_1":"Icon_Console_Number_21_3in_FPD_Non_TS","var_23_2":"Icon_Console_Number_21_3in_FPD_TS"},"TPS_EX_Service":{"var_28":"Qty_Existing_Cabinets_Server_Switches_Stations","var_2":"TPS_EX_Will_System_be_migrated_virtual_system","var_29":"TPS_Will_Honeywell_perform_equipment_installation"}}#"MSID_Will_Honeywell_perform_equipment_installation"}}
	for key in parameters:
		if key == "TPS_EX_General_Questions":
			var_1 = getRowData(Product,key,parameters[key]["var_1"])
			if var_1 == '':
				var_1 = "YES"
			var_34 = getFloat(getRowData(Product,key,parameters[key]["var_34"]))
			var_27 = getFloat(getRowData(Product,key,parameters[key]["var_27"]))
			var_41 = getRowData(Product,key,parameters[key]["var_41"])
		...
		if key == "TPS_EX_Conversion_ESVT_Server":
			...
			var_8 = getFloat(getRowData(Product,key,parameters[key]["var_8"]))
			var_3_1 = getFloat(getRowData(Product,key,parameters[key]["var_3_1"]))
			var_3_2 = getRowData(Product,key,parameters[key]["var_3_2"])
		...
		if key == "TPS_EX_Bundle_Conversion_Server_Stations":
			var_52 = getRowData(Product,key,parameters[key]["var_4_1"])
			var_51 = getRowData(Product,key,parameters[key]["var_3_1"])
		...
		if key == "TPS_EX_Monitors":
			var_21 = getFloat(getRowData(Product,key,parameters[key]["var_21_1"])) + getFloat(getRowData(Product,key,parameters[key]["var_21_2"])) + getFloat(getRowData(Product,key,parameters[key]["var_21_3"])) + getFloat(getRowData(Product,key,parameters[key]["var_21_4"])) + getFloat(getRowData(Product,key,parameters[key]["var_21_5"])) + getFloat(getRowData(Product,key,parameters[key]["var_21_6"]))
			var_22 = getFloat(getRowData(Product,key,parameters[key]["var_22_1"])) + getFloat(getRowData(Product,key,parameters[key]["var_22_2"])) + getFloat(getRowData(Product,key,parameters[key]["var_22_3"])) + getFloat(getRowData(Product,key,parameters[key]["var_22_4"])) + getFloat(getRowData(Product,key,parameters[key]["var_22_5"]))
			var_26 = getFloat(getRowData(Product,key,parameters[key]["var_26_1"])) + getFloat(getRowData(Product,key,parameters[key]["var_26_2"]))
			var_25 = getFloat(getRowData(Product,key,parameters[key]["var_25_1"])) + getFloat(getRowData(Product,key,parameters[key]["var_25_2"])) + getFloat(getRowData(Product,key,parameters[key]["var_25_3"])) + getFloat(getRowData(Product,key,parameters[key]["var_25_4"]))
			var_23 = getFloat(getRowData(Product,key,parameters[key]["var_23_1"])) + getFloat(getRowData(Product,key,parameters[key]["var_23_2"]))
...
def getTCMILabourHours(Product):
	...
	for key in parameters:
		...
		if key == "TCMI_Services":
			var_cc = getRowData(Product,key,parameters[key]["cc1"])
...
def calculateELCNHWSWOrder(Product):
	for row in getContainer(Product,"EBR_New_Additional_EBR").Rows:
...
def calculateELCNSiteInstallationAndSAT(var17,var18,var11,var12,var13,var14,var15,var16,var22,var23,var24,var25,var26,var27,var1,var2,var3,var4,var7,var8,var9,var10,var5,var6,var21,var29,var28):
	...
	if var18 == "Yes":
		...
		Trace.Write("siteInstallationHours_1"+str(siteInstallationHours))
		siteInstallationHours += var5 * 2.8 if var5 > 4 else var5 * 4
		Trace.Write("siteInstallationHours_2"+str(siteInstallationHours))
		siteInstallationHours += var6 * 2.8 if var6 > 4 else var6 * 4
		Trace.Write("siteInstallationHours_3"+str(siteInstallationHours))
		siteInstallationHours += (var22 * 16 + var23 * 16 + var24 * 12 + var25 * 16 + var26 * 8 + var27 * 20) + (var22 + var23 + var24 + var25 + var26 + var27 ) * 5
		Trace.Write("siteInstallationHours_4"+str(siteInstallationHours))
	siteInstallationHours += var21
	Trace.Write("siteInstallationHours_5"+str(siteInstallationHours))
	siteInstallationHours += 0 if var29 == "Yes" else -4
	Trace.Write("siteInstallationHours_6"+str(siteInstallationHours))
