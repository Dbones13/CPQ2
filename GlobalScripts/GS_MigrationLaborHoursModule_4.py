...
def getGraphicsMigrationLabourHours(Product):
    
    parameters ={"Graphics_Migration_Migration_Scenario":{"var_51":"Graphics_Migration_For_existing_US_GUS_DSP_what_percentage_of_Standard_Builds_will_be_used?","var_1":"Graphics_Migration_Select_Vertical_Market_Picklist_with_values","var_34":"Graphics_Migration_Have_specific_native_or_GUS_displays_that_support_a_specific_application?","var_33":"Graphics_Migration_Require_an_HMI_interface_for_AM_or_HPM_CL_applications?","var_32":"Graphics_Migration_Willing_to_accept_alternative_visualization_solution_for_specific_functions?","var_31":"Graphics_Migration_Have_array_point_that_requires_a_HMIWeb_interface?","var_16":"Graphics_Migration_Using_device_control_digital_composite_block_for_all_digital_equipment?","var_17":"Graphics_Migration_Have_multiple_DI_or_DO_parameters_that_must_be_combined_in_one_shape?","var_18":"Graphics_Migration_Require_multi_tag_shapes?","var_19":"Graphics_Migration_Have_process_module_point_AM_custom_Data_points_as_part_of_the_point_config","var_20":"Graphics_Migration_Is_Standard_Builds_used_for_EXP_to_EXP?","var_21":"Graphics_Migration_Is_the_system_connected_to_Hiway_Gateway_Controllers?","var_26":"Graphics_Migration_Type_of_Existing_Displays"},"Graphics_Migration_Displays_Shapes_Faceplates":{"var_35":"Experion_shapes_multiplier","var_2":"Total_Number_of_Displays","var_3":"Number_of_Simple_Displays","var_4":"Number_of_Medium_Displays","var_5":"Number_of_Complex_Displays","var_6":"Number_of_Very_Complex_Displays","var_7":"Number_of_Repeats_Displays","var_8":"Total_Number_of_Custom_Shapes","var_9":"Number_of_Simple_Custom_Shapes","var_10":"Number_of_Medium_Custom_Shapes","var_11":"Number_of_Complex_Custom_Shapes","var_12":"Number_of_Very_Complex_Custom_Shapes","var_13":"Number_of_Repeats_Custom_Shapes","var_14":"Total_Number_of_Custom_Faceplates","var_15":"Number_of_Custom_Context_Menus","var_37":"Number_of_Simple_Custom_Faceplates","var_38":"Number_of_Medium_Custom_Faceplates","var_39":"Number_of_Complex_Custom_Faceplates","var_40":"Number_of_Very_Complex_Custom_Faceplates","var_41":"Number_of_Repeats_Custom_Faceplates"},"Graphics_Migration_Training_Testing_Documentation":{"var_50":"Graphics_Migration_DDS_Required?","var_49":"Graphics_Migration_FDS_Required?","var_22":"Graphics_Migration_FAT_required?","var_23":"Graphics_Migration_Does_the_customer_require_SAT?","var_24":"Graphics_Migration_Does_the_customer_require_Operator_Training_Basic?","var_25":"Graphics_Migration_How_many_training_sessions_are_required?"},"Graphics_Migration_Additional_Questions":{"var_36":"Graphics_Migration_For_GAP_Analysis_project_com","var_27":"Graphics_Migration_Gap_Analysis_done?","var_42":"Graphics_Migration_DCA_IRA_done","var_43":"Graphics_Migration_New_Safeview_Configuration","var_44":"Graphics_Migration_Alarm_groups_configured?","var_45":"Graphics_Migration_Number_of_station_licenses","var_29":"Graphics_Migration_Additional_hours_for_customized_graphics_after_GAP_analysis","var_48":"Graphics_Migration_Number_of_object_scripts_to_be_implemented"}}
    for key in parameters:
        if key == "Graphics_Migration_Migration_Scenario":
            ...
            var_26 = getRowData(Product,key,parameters[key]["var_26"])
        ...
        if key == "Graphics_Migration_Training_Testing_Documentation":
            var_49 = getRowData(Product,key,parameters[key]["var_49"])
            var_50 = getRowData(Product,key,parameters[key]["var_50"])
        ...
        if key == "Graphics_Migration_Additional_Questions":
            var_45 = getFloat(getRowData(Product,key,parameters[key]["var_45"]))
            var_36 = getRowData(Product,key,parameters[key]["var_36"])
            var_27 = getRowData(Product,key,parameters[key]["var_27"])
            var_42 = getRowData(Product,key,parameters[key]["var_42"])
            var_43 = getRowData(Product,key,parameters[key]["var_43"])
            var_44 = getRowData(Product,key,parameters[key]["var_44"])
            var_29 = getFloat(getRowData(Product,key,parameters[key]["var_29"]))
            var_48 = getFloat(getRowData(Product,key,parameters[key]["var_48"]))

    Ges_Location=Product.Attr('MSID_GES_Location').GetValue()
...
def getCDActuatorLabourHours(Product):
    ...
    parameters ={"CD_Actuator_IF_Upgrade_General_Info_Cont":{"var_1":"CD_Actuator_Number_of_Actuators_Zones","var_2":"CD_Actuator_Actuator_Type","var_3":"CD_Actuator_Interlocks","var_4":"CD_Actuator_QCS_Type","var_5":"CD_Actuator_Lynk_Type"},"CD_Actuator_IF_Upgrade_Services_Cont":{"var_8":"CD_Actuator_SAT_required","var_9":"CD_Actuator_HSE_and_Quality_Plan_required","var_10":"CD_Actuator_Update_existing_documents"}}
...
def getFSCTOSMIOLabourHours(Product):
    ...
    con = getContainer(Product,'FSC_to_SM_IO_Migration_General_Information')
    conrow = con.Rows[0]
    var_1 = getFloat(conrow['FSC_to_SM_IO_Migration_Total_FSC_SM_Systems'])
    ...
    con2row = con2.Rows[0]
    var_6 = getFloat(con2row['FSC_to_SM_IO_In_Office_Eng_hours_per_Audit_Report'])
    var_7 = getFloat(con2row['FSC_to_SM_IO_On_Site_Eng_hours_per_Audit_Report'])
    
    con3 = getContainer(Product,'FSC_to_SM_IO_Services')
    con3row = con3.Rows[0]
    var_4 = con3row['FSC_to_SM_IO_Is_Honeywell_executing_the_field_cros']
    var_12 = con3row['FSC_to_SM_IO_Software_Factory_Acceptance_Test_Requ']
    ranm = con3row['FSC_to_SM_IO_Has_the_FSC_IO_Audit_been_performed']
    if ranm == "No":
        var_9 = "Yes"
    else:
        var_9= "No"
