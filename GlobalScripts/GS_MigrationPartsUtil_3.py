...
def updateAttrDictWithCustomxPMC300(product, attrValDict, Quote):
    ...
    getContainer(product, 'MSID_CommonQuestions')
    ...
    for row in con1.Rows:
        ...
        if powersupplyupgrade == 'Yes':
            MC_ZPSUG2 += 1
        if powersystemupgrade == 'Yes':
            MC_ZPSR04 += 1
    ...
    attrValDict["CU-PWPR20"] = CU_PWPR20
    attrValDict["CU-PWPN20"] = CU_PWPN20
