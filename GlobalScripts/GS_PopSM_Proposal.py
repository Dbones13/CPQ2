def populateSMproposal(Quote, SMItem, guid):
	...
	sys_name = SMItem.ProductName
	newRow["System_Name"] = sys_name
	sys_name_guid = SMItem.QuoteItemGuid
	newRow["System_Item_GUID"] = sys_name_guid
	sys_grp = guid[SMItem.ParentItemGuid]
	newRow["System_Group"] = sys_grp
	sys_grp_guid = SMItem.ParentItemGuid
	newRow["System_Grp_GUID"] = sys_grp_guid
	newRow["RolledUpQuoteItem"] = SMItem.RolledUpQuoteItem
		
	for Item in SMItem.Children:
		#for level 3
		if Item.ProductName == "SM Control Group":
			newRow = QT_Table.AddNewRow()
			...
			cg_right_cont_rows = Item.SelectedAttributes.GetContainerByName('SM_CG_Cabinet_Details_Cont_Right').Rows
			cg_left_cont_rows = Item.SelectedAttributes.GetContainerByName('SM_CG_Cabinet_Details_Cont_Left').Rows
			...
			di_cont_rows = Item.SelectedAttributes.GetContainerByName("SM_IO_Count_Digital_Input_Cont").Rows
			do_cont_rows = Item.SelectedAttributes.GetContainerByName("SM_IO_Count_Digital_Output_Cont").Rows
			ao_cont_rows = Item.SelectedAttributes.GetContainerByName("SM_IO_Count_Analog_Output_Cont").Rows
			ai_cont_rows = Item.SelectedAttributes.GetContainerByName("SM_IO_Count_Analog_Input_Cont").Rows
				...
				if leftRow['Marshalling_Option'] == "Universal_Marshalling":
					for rightRow in cg_right_cont_rows :
						...
						if sil == 'Yes' or nmr == 'Yes':
							attr_containers3 = Item.SelectedAttributes.GetContainerByName("SM_CG_DI_RLY_NMR_Cont").Rows
							...
							attr_containers4 = Item.SelectedAttributes.GetContainerByName("SM_CG_DO_RLY_NMR_Cont").Rows
			...
			for rg in Item.Children:
				if rg.ProductName == "SM Remote Group":
					n += 1
