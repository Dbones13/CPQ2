def populateEXP_ENTData(Quote):
    hierarchy = {'Level0': "New / Expansion Project", 'Level1': "System Group", 'Level2': "Experion Enterprise System"}
    ...
    if SM == 'No':
        for row in QT_Table.Rows:
            if row["System_Name"] == 'Experion Enterprise System':
                rowId = row.Id
