#CXCPQ-34222 {ADDED BY SHIVANI}
#parts_dict={}
def get_identifier_UPTA01(Product,parts_dict):
    ...
    if Enclosure_Type == "Universal Safety Cab-1.3M":
        if len(Identifier_Modifier)>20 and Specify_Identifier=="Yes" and Safety_Cabinets_qnt >0:
            if (Identifier_Modifier[3]=="S" or Identifier_Modifier[3]=="X") and Identifier_Modifier[13]=="R":
                var=0
                if (Identifier_Modifier[6]=="U") and (Identifier_Modifier[8]=="X") and Identifier_Modifier[9]=="B": #43
                    var= Safety_Cabinets_qnt * 64
                if (Identifier_Modifier[6]=="U") and (Identifier_Modifier[8]=="X") and Identifier_Modifier[9]=="A": #41
                    var= Safety_Cabinets_qnt * 32
                ...
                if (Identifier_Modifier[6]=="A") and (Identifier_Modifier[8]=="X") and Identifier_Modifier[9]=="C": #16
                    var= Safety_Cabinets_qnt * 64
                if (Identifier_Modifier[6]=="U") and (Identifier_Modifier[8]=="X") and Identifier_Modifier[9]=="C": #15
                    var= Safety_Cabinets_qnt * 96
                ...
                if (Identifier_Modifier[5]=="A") and (Identifier_Modifier[8]=="C") and Identifier_Modifier[9]=="X": #58
                    var= Safety_Cabinets_qnt * 64
                if (Identifier_Modifier[5]=="U") and (Identifier_Modifier[8]=="C") and Identifier_Modifier[9]=="X": #57
                    var= Safety_Cabinets_qnt * 96
                if Identifier_Modifier[5]=="C" and Identifier_Modifier[8]=="B" and Identifier_Modifier[9]=="X": #4
                    var= Safety_Cabinets_qnt * 32
                if (Identifier_Modifier[5]=="U") and (Identifier_Modifier[8]=="A") and Identifier_Modifier[9]=="X": #1
                    var= Safety_Cabinets_qnt * 32
                if Identifier_Modifier[5]=="U" and Identifier_Modifier[8]=="B" and Identifier_Modifier[9]=="X": #3
                    var= Safety_Cabinets_qnt * 64
                if Identifier_Modifier[5]=="M" and Identifier_Modifier[6]=="C" and Identifier_Modifier[8]=="A" and Identifier_Modifier[9]=="B": #54
                    var= Safety_Cabinets_qnt * 32
                if Identifier_Modifier[5]=="M" and Identifier_Modifier[6]=="U" and Identifier_Modifier[8]=="A" and Identifier_Modifier[9]=="B": #53
                    var= Safety_Cabinets_qnt * 64
                ...
                if Identifier_Modifier[5]=="I" and Identifier_Modifier[6]=="U" and Identifier_Modifier[8]=="A" and Identifier_Modifier[9]=="A": #48
                    var= Safety_Cabinets_qnt * 32
                if Identifier_Modifier[5]=="U" and Identifier_Modifier[6]=="U" and Identifier_Modifier[8]=="A" and Identifier_Modifier[9]=="A": #47
                    var= Safety_Cabinets_qnt * 64
                if Identifier_Modifier[5]=="M" and Identifier_Modifier[6]=="U" and Identifier_Modifier[8]=="A" and Identifier_Modifier[9]=="A": #39
                    var= Safety_Cabinets_qnt * 32
                ...
                if Identifier_Modifier[5]=="U" and Identifier_Modifier[6]=="I" and Identifier_Modifier[8]=="B" and Identifier_Modifier[9]=="A": #32
                    var= Safety_Cabinets_qnt * 64
                if Identifier_Modifier[5]=="U" and Identifier_Modifier[6]=="U" and Identifier_Modifier[8]=="B" and Identifier_Modifier[9]=="A": #31
                    var= Safety_Cabinets_qnt * 96
                if Identifier_Modifier[5]=="M" and Identifier_Modifier[6]=="U" and Identifier_Modifier[8]=="B" and Identifier_Modifier[9]=="A": #29
                    var= Safety_Cabinets_qnt * 32
                ...
                if Identifier_Modifier[5]=="U" and Identifier_Modifier[6]=="C" and Identifier_Modifier[8]=="A" and Identifier_Modifier[9]=="B": #22
                    var= Safety_Cabinets_qnt * 32
                if Identifier_Modifier[5]=="U" and Identifier_Modifier[6]=="U" and Identifier_Modifier[8]=="A" and Identifier_Modifier[9]=="B": #21
                    var= Safety_Cabinets_qnt * 96
                if Identifier_Modifier[5]=="C" and Identifier_Modifier[6]=="M" and Identifier_Modifier[8]=="B" and Identifier_Modifier[9]=="A": #12
                    var= Safety_Cabinets_qnt * 32
                if Identifier_Modifier[5]=="U" and Identifier_Modifier[6]=="M" and Identifier_Modifier[8]=="A" and (Identifier_Modifier[9]=="A" or Identifier_Modifier[9]=="B"): #7/9
                    var= Safety_Cabinets_qnt * 32
                if Identifier_Modifier[5]=="U" and Identifier_Modifier[6]=="M" and Identifier_Modifier[8]=="B" and Identifier_Modifier[9]=="A": #11
                    var= Safety_Cabinets_qnt * 64
                parts_dict["CC-UPTA01"] = {"Quantity" : int(var), "Description" : "Pass Through Adapter"}
            elif (Identifier_Modifier[3]=="S" or Identifier_Modifier[3]== "X") and Identifier_Modifier[13]=="X":
                var=0
                if (Identifier_Modifier[6]=="U") and (Identifier_Modifier[8]=="X") and Identifier_Modifier[9]=="C": #18
                    var= Safety_Cabinets_qnt * 96
                elif (Identifier_Modifier[6]=="U") and (Identifier_Modifier[8]=="X") and Identifier_Modifier[9]=="B": #45
                    var= Safety_Cabinets_qnt * 64
                elif (Identifier_Modifier[6]=="C") and (Identifier_Modifier[8]=="X") and Identifier_Modifier[9]=="B": #46
                    var= Safety_Cabinets_qnt * 32
                elif (Identifier_Modifier[6]=="U") and (Identifier_Modifier[8]=="X") and Identifier_Modifier[9]=="A": #42
                    var= Safety_Cabinets_qnt * 32
                    ...
                    var= Safety_Cabinets_qnt * 64
                elif (Identifier_Modifier[5]=="U") and (Identifier_Modifier[8]=="C") and Identifier_Modifier[9]=="X": #60
                    var= Safety_Cabinets_qnt * 96
                elif Identifier_Modifier[5]=="C" and Identifier_Modifier[8]=="B" and Identifier_Modifier[9]=="X": #6
                    var= Safety_Cabinets_qnt * 32
                elif (Identifier_Modifier[5]=="U") and (Identifier_Modifier[8]=="A") and Identifier_Modifier[9]=="X": #2
                    var= Safety_Cabinets_qnt * 32
                elif Identifier_Modifier[5]=="U" and Identifier_Modifier[8]=="B" and Identifier_Modifier[9]=="X": #5
                    var= Safety_Cabinets_qnt * 64
                elif Identifier_Modifier[5]=="M" and Identifier_Modifier[6]=="C" and Identifier_Modifier[8]=="A" and Identifier_Modifier[9]=="B": #56
                    var= Safety_Cabinets_qnt * 32
                elif Identifier_Modifier[5]=="M" and Identifier_Modifier[6]=="U" and Identifier_Modifier[8]=="A" and Identifier_Modifier[9]=="B": #55
                    var= Safety_Cabinets_qnt * 64
                    ...
                    var= Safety_Cabinets_qnt * 32
                elif Identifier_Modifier[5]=="U" and Identifier_Modifier[6]=="U" and Identifier_Modifier[8]=="A" and Identifier_Modifier[9]=="A": #50
                    var= Safety_Cabinets_qnt * 64
                elif Identifier_Modifier[5]=="M" and Identifier_Modifier[6]=="U" and Identifier_Modifier[8]=="A" and Identifier_Modifier[9]=="A": #40
                    var= Safety_Cabinets_qnt * 32
                    ...
                    var= Safety_Cabinets_qnt * 64
                elif Identifier_Modifier[5]=="U" and Identifier_Modifier[6]=="U" and Identifier_Modifier[8]=="B" and Identifier_Modifier[9]=="A": #35
                    var= Safety_Cabinets_qnt * 96
                elif Identifier_Modifier[5]=="M" and Identifier_Modifier[6]=="U" and Identifier_Modifier[8]=="B" and Identifier_Modifier[9]=="A": #30
                    var= Safety_Cabinets_qnt * 32
                    ...
                    var= Safety_Cabinets_qnt * 32
                elif Identifier_Modifier[5]=="U" and Identifier_Modifier[6]=="U" and Identifier_Modifier[8]=="A" and Identifier_Modifier[9]=="B": #25
                    var= Safety_Cabinets_qnt * 96
                elif Identifier_Modifier[5]=="C" and Identifier_Modifier[6]=="M" and Identifier_Modifier[8]=="B" and Identifier_Modifier[9]=="A": #14
                    var= Safety_Cabinets_qnt * 32
                elif Identifier_Modifier[5]=="U" and Identifier_Modifier[6]=="M" and Identifier_Modifier[8]=="A" and (Identifier_Modifier[9]=="A" or Identifier_Modifier[9]=="B"): #8/10
                    var= Safety_Cabinets_qnt * 32
                elif Identifier_Modifier[5]=="U" and Identifier_Modifier[6]=="M" and Identifier_Modifier[8]=="B" and Identifier_Modifier[9]=="A": #13
                    var= Safety_Cabinets_qnt * 64
                parts_dict["CC-UPTA01"] = {"Quantity" : int(var), "Description" : "Pass Through Adapter"}
            ...
            if Field_for_PUIO=="32 IS, 32 Non-IS" and (PUIO_Count=="64")and PDIO_Count=="0": #4
                var= 32 * Safety_Cabinets_qnt
            elif Field_for_PUIO=="Universal Marshalling, PTA" and (PUIO_Count=="64")and PDIO_Count=="0": #3
                var= 64 * Safety_Cabinets_qnt
            elif Field_for_PUIO=="Universal Marshalling, PTA" and (PDIO_Count=="0")and PUIO_Count=="32": #1
                var= 32 * Safety_Cabinets_qnt
            elif Field_for_PUIO=="64 IS, 32 Non-IS" and (PUIO_Count=="96")and PDIO_Count=="0": #59
                var= 32 * Safety_Cabinets_qnt
            elif Field_for_PUIO=="32 IS, 64 Non-IS" and (PUIO_Count=="96")and PDIO_Count=="0": #58
                var= 64 * Safety_Cabinets_qnt
            elif Field_for_PUIO=="Universal Marshalling, PTA" and (PUIO_Count=="96")and PDIO_Count=="0": #57
                var= 96 * Safety_Cabinets_qnt
            elif Field_for_PDIO=="32 IS, 32 Non-IS" and (PUIO_Count=="0")and PDIO_Count=="64": #44
                var= 32 * Safety_Cabinets_qnt
            elif Field_for_PDIO=="Universal Marshalling, PTA" and (PUIO_Count=="0")and PDIO_Count=="64": #43
                var= 64 * Safety_Cabinets_qnt
            elif Field_for_PDIO=="Universal Marshalling, PTA" and (PUIO_Count=="0")and PDIO_Count=="32": #41
                var= 32 * Safety_Cabinets_qnt
                ...
                var= 64 * Safety_Cabinets_qnt
            elif Field_for_PDIO=="Universal Marshalling, PTA" and (PUIO_Count=="0")and PDIO_Count=="96": #15
                var= 96 * Safety_Cabinets_qnt
                ...
                var= 32 * Safety_Cabinets_qnt
            elif Field_for_PUIO =="Default Marshalling FC-TUIO51/52" and Field_for_PDIO=="Universal Marshalling, PTA" and PUIO_Count=="32" and PDIO_Count=="64": #53
                var= 64 * Safety_Cabinets_qnt
                ...
                var= 32 * Safety_Cabinets_qnt
            elif Field_for_PUIO =="Universal Marshalling, PTA" and Field_for_PDIO=="Universal Marshalling, PTA" and PUIO_Count=="32" and PDIO_Count=="32": #47
                var= 64 * Safety_Cabinets_qnt
            elif Field_for_PUIO =="Default Marshalling FC-TUIO51/52" and Field_for_PDIO=="Universal Marshalling, PTA" and PUIO_Count=="32" and PDIO_Count=="32": #39
                var= 32 * Safety_Cabinets_qnt
                ...
                var= 64 * Safety_Cabinets_qnt
            elif Field_for_PUIO =="Universal Marshalling, PTA" and Field_for_PDIO=="Universal Marshalling, PTA" and PUIO_Count=="64" and PDIO_Count=="32": #31
                var= 96 * Safety_Cabinets_qnt
            elif Field_for_PUIO =="Default Marshalling FC-TUIO51/52" and Field_for_PDIO=="Universal Marshalling, PTA" and PUIO_Count=="64" and PDIO_Count=="32": #29
                var= 32 * Safety_Cabinets_qnt
                ...
                var= 32 * Safety_Cabinets_qnt
            elif Field_for_PUIO =="Universal Marshalling, PTA" and Field_for_PDIO=="Universal Marshalling, PTA" and PUIO_Count=="32" and PDIO_Count=="64": #21
                var= 96 * Safety_Cabinets_qnt
                ...
                var= 32 * Safety_Cabinets_qnt
            elif Field_for_PUIO =="Universal Marshalling, PTA" and Field_for_PDIO=="Default Marshalling FC-TDIO51/52" and PUIO_Count=="64" and PDIO_Count=="32": #11
                var= 64 * Safety_Cabinets_qnt
            elif Field_for_PUIO =="Universal Marshalling, PTA" and Field_for_PDIO=="Default Marshalling FC-TDIO51/52" and PUIO_Count=="32" and (PDIO_Count=="32" or PDIO_Count=="64"): #7/9
                var= 32 * Safety_Cabinets_qnt
            parts_dict["CC-UPTA01"] = {"Quantity" : int(var), "Description" : "Pass Through Adapter"}
        elif Specify_Identifier=="No" and (S300=="Redundant S300" or "No S300") and IO_Redundancy=="Non Redundant IO" and Safety_Cabinets_qnt >0:
            var=0
            Trace.Write("AAA")
            if Field_for_PUIO=="32 IS, 32 Non-IS" and (PUIO_Count=="64"or '' )and PDIO_Count=="0": #6
                var= 32 * Safety_Cabinets_qnt
            elif Field_for_PUIO=="Universal Marshalling, PTA" and (PUIO_Count=="64"or '' )and PDIO_Count=="0": #5
                var= 64 * Safety_Cabinets_qnt
            elif Field_for_PUIO=="Universal Marshalling, PTA" and (PUIO_Count=="32"or '' )and PDIO_Count=="0": #2
                var= 32 * Safety_Cabinets_qnt
            elif Field_for_PUIO=="64 IS, 32 Non-IS" and (PUIO_Count=="96"or '' )and PDIO_Count=="0": #62
                var= 32 * Safety_Cabinets_qnt
            elif Field_for_PUIO=="32 IS, 64 Non-IS" and (PUIO_Count=="96"or '' )and PDIO_Count=="0": #61
                var= 64 * Safety_Cabinets_qnt
            elif Field_for_PUIO=="Universal Marshalling, PTA" and (PUIO_Count=="96"or '' )and PDIO_Count=="0": #60
                var= 96 * Safety_Cabinets_qnt
            elif Field_for_PDIO=="Universal Marshalling, PTA" and (PUIO_Count=="0"or '' )and PDIO_Count=="64": #45
                var= 64 * Safety_Cabinets_qnt
            elif Field_for_PDIO=="32 IS, 32 Non-IS" and (PUIO_Count=="0"or '' )and PDIO_Count=="64": #46
                var= 32 * Safety_Cabinets_qnt
            elif Field_for_PDIO=="Universal Marshalling, PTA" and (PUIO_Count=="0"or '' )and PDIO_Count=="32": #42
                var= 32 * Safety_Cabinets_qnt
                ...
                var= 64 * Safety_Cabinets_qnt
            elif Field_for_PDIO=="Universal Marshalling, PTA" and (PUIO_Count=="0"or '' )and PDIO_Count=="96": #18
                var= 96 * Safety_Cabinets_qnt
                ...
                var= 32 * Safety_Cabinets_qnt
            elif Field_for_PUIO =="Default Marshalling FC-TUIO51/52" and Field_for_PDIO=="Universal Marshalling, PTA" and PUIO_Count=="32" and PDIO_Count=="64": #55
                var= 64 * Safety_Cabinets_qnt
            elif Field_for_PUIO =="Universal Marshalling, PTA" and Field_for_PDIO=="Universal Marshalling, PTA" and PUIO_Count=="32" and PDIO_Count=="32": #50
                var= 64 * Safety_Cabinets_qnt
                ...
                var= 32 * Safety_Cabinets_qnt
            elif Field_for_PUIO =="Default Marshalling FC-TUIO51/52" and Field_for_PDIO=="Universal Marshalling, PTA" and PUIO_Count=="32" and PDIO_Count=="32": #40
                var= 32 * Safety_Cabinets_qnt
                ...
                var= 64 * Safety_Cabinets_qnt
            elif Field_for_PUIO =="Universal Marshalling, PTA" and Field_for_PDIO=="Universal Marshalling, PTA" and PUIO_Count=="64" and PDIO_Count=="32": #35
                var= 96 * Safety_Cabinets_qnt
            elif Field_for_PDIO =="Universal Marshalling, PTA" and Field_for_PUIO=="Default Marshalling FC-TUIO51/52" and PUIO_Count=="64" and PDIO_Count=="32":#30
                Trace.Write("CCC")
                var= 32 * Safety_Cabinets_qnt
            #elif Field_for_PUIO =="Default Marshaling FC-TUIO51/52  Default Marshalling FC-TUIO51/52" and Field_for_PDIO=="Universal Marshalling, PTA" and PUIO_Count=="64" and PDIO_Count=="32" and IO_Redundancy=="Non Redundant IO": #30
                ...
                var= 32 * Safety_Cabinets_qnt
            elif Field_for_PUIO =="Universal Marshalling, PTA" and Field_for_PDIO=="Universal Marshalling, PTA" and PUIO_Count=="32" and PDIO_Count=="64": #25
                var= 96 * Safety_Cabinets_qnt
                ...
                var= 32 * Safety_Cabinets_qnt
            elif Field_for_PUIO =="Universal Marshalling, PTA" and Field_for_PDIO=="Default Marshalling FC-TDIO51/52" and PUIO_Count=="64" and PDIO_Count=="32": #13
                var= 64 * Safety_Cabinets_qnt
            elif Field_for_PUIO =="Universal Marshalling, PTA" and Field_for_PDIO=="Default Marshalling FC-TDIO51/52" and PUIO_Count=="32" and (PDIO_Count=="32" or PDIO_Count=="64"): #7/9
                var= 32 * Safety_Cabinets_qnt
            parts_dict["CC-UPTA01"] = {"Quantity" : int(var), "Description" : "Pass Through Adapter"}
    return parts_dict
#X=get_identifier_UPTA01(Product,parts_dict)
#Trace.Write(str(X))