...
panel_1U=[x for x in SPARE_PARTS_SERVER_CABINET_LIST if (x.Panel_Unit == '1')]
...
panel_2U=[x for x in SPARE_PARTS_SERVER_CABINET_LIST if (x.Panel_Unit == '2')]
...
panel_3U=[x for x in SPARE_PARTS_SERVER_CABINET_LIST if (x.Panel_Unit == '3')]
...
panel_4U=[x for x in SPARE_PARTS_SERVER_CABINET_LIST if (x.Panel_Unit == '4')]

if val_1u != 0 and val_1u != "":
    for part in panel_1U:
        setAtvQty('Spare_Parts_Server_Cabinet_PartSummary',part.Part_Number,int(val_1u))
if val_2u != 0 and val_2u != "":
    for part in panel_2U:
        setAtvQty('Spare_Parts_Server_Cabinet_PartSummary',part.Part_Number,int(val_2u))
if val_3u != 0 and val_3u != "":
    for part in panel_3U:
        setAtvQty('Spare_Parts_Server_Cabinet_PartSummary',part.Part_Number,int(val_3u))
if val_4u != 0 and val_4u != "":
    for part in panel_4U:
        setAtvQty('Spare_Parts_Server_Cabinet_PartSummary',part.Part_Number,int(val_4u))