...
def PartSummaryEntGrp(Product,Quote):
	...
	if NS=="Honeywell" and BackRelease=="R501":
		EP_COAS16SR=SR16
	if NS=="Honeywell" and (BackRelease=="R520" or (ESR=="R520" and TPM=="Yes")):
		EP_COAS19SR=SR19
	...
	if (ESR=='R530'or ESR=='R520'):
		MZ_PCSV85_qty = GS_Exp_ENT_BOM_Calcs.station_qnt1(Product,'SVR_PER_HP_Rack_RAID5','SVR_PER_HP_Rack_RAID5')
		if  MZ_PCSV85_qty > 0:
			GS_PS_Exp_Ent_BOM.setAtvQty(Product,"Exp_Ent_Grp_Part_Summary","MZ-PCSV85",MZ_PCSV85_qty)
	'''
	...
	#CXCPQ-37567,38252
	#  Commented For CXCPQ-86022:- Saurabh
	"""#CXCPQ-37567,38252
	GS_PS_Exp_Ent_BOM.setAtvQty(Product,"Exp_Ent_Grp_Part_Summary","MZ-PCWS93",0)
	GS_PS_Exp_Ent_BOM.setAtvQty(Product,"Exp_Ent_Grp_Part_Summary","MZ-PCWS94",0)
	Release=Product.Attr('Experion Software Release').GetValue()
	MZ_PCWS93_qty = GS_BOM_exp_ent_grp.station_qnt1(Product,'SVR_F_PER_DELL_Tower_RAID1','STN_PER_DELL_Tower_RAID1')
	if MZ_PCWS93_qty > 0:
		Release=Product.Attr('Experion Software Release').GetValue()
		if Release=='R510' or Release=='R511':
			GS_PS_Exp_Ent_BOM.setAtvQty(Product,"Exp_Ent_Grp_Part_Summary","MZ-PCWS93",MZ_PCWS93_qty)
		#CXCPQ-38252
		if Release=='R520' and LOB=="PAS":
			GS_PS_Exp_Ent_BOM.setAtvQty(Product,"Exp_Ent_Grp_Part_Summary","MZ-PCWS94",MZ_PCWS93_qty)
	#CXCPQ-37568
	MZ_PCWS77_qty = GS_BOM_exp_ent_grp.station_qnt3(Product,'SVR_F_PER_DELL_Rack_RAID1','STN_PER_DELL_Rack_RAID1')
	Trace.Write(MZ_PCWS77_qty)
	if MZ_PCWS77_qty > 0 and ESR!='R530':
		Trace.Write("37568")
		GS_PS_Exp_Ent_BOM.setAtvQty(Product,"Exp_Ent_Grp_Part_Summary","MZ-PCWS77",MZ_PCWS77_qty)
	else:
		Trace.Write("37568")
		GS_PS_Exp_Ent_BOM.setAtvQty(Product,"Exp_Ent_Grp_Part_Summary","MZ-PCWS77",0)"""
	...
	if Qnt2+MZ_PCSR01SR >0:
		...
		GS_PS_Exp_Ent_BOM.setAtvQty(Product,"Exp_Ent_Grp_Part_Summary","MZ-PCSR01",0)
	if Qnt3+MZ_PCSR02SR >0:
		GS_PS_Exp_Ent_BOM.setAtvQty(Product,"Exp_Ent_Grp_Part_Summary","MZ-PCSR02",Qnt3+MZ_PCSR02SR)
	else:
		GS_PS_Exp_Ent_BOM.setAtvQty(Product,"Exp_Ent_Grp_Part_Summary","MZ-PCSR02",0)
	if Qnt4+MZ_PCSR82SR >0:
		GS_PS_Exp_Ent_BOM.setAtvQty(Product,"Exp_Ent_Grp_Part_Summary","MZ-PCSR82",Qnt4+MZ_PCSR82SR)
	else:
		GS_PS_Exp_Ent_BOM.setAtvQty(Product,"Exp_Ent_Grp_Part_Summary","MZ-PCSR82",0)
	...
	if Qnt7+MZ_PCST01SR >0:
		...
		GS_PS_Exp_Ent_BOM.setAtvQty(Product,"Exp_Ent_Grp_Part_Summary","MZ-PCST01",0)
	if Qnt8+MZ_PCST02SR >0:
		GS_PS_Exp_Ent_BOM.setAtvQty(Product,"Exp_Ent_Grp_Part_Summary","MZ-PCST02",Qnt8+MZ_PCST02SR)
	else:
		GS_PS_Exp_Ent_BOM.setAtvQty(Product,"Exp_Ent_Grp_Part_Summary","MZ-PCST02",0)
	if Qnt9+MZ_PCST82SR >0:
		GS_PS_Exp_Ent_BOM.setAtvQty(Product,"Exp_Ent_Grp_Part_Summary","MZ-PCST82",Qnt9+MZ_PCST82SR)
	else:
		GS_PS_Exp_Ent_BOM.setAtvQty(Product,"Exp_Ent_Grp_Part_Summary","MZ-PCST82",0)
	...
	if Release=='R520':
		serever_qntnode_FinalR520=serever_qntnode_T
	...
	#CCEECOMMBR-7709
	'''if svr_hardt37552 >0:
		GS_PS_Exp_Ent_BOM.setAtvQty(Product,"Exp_Ent_Grp_Part_Summary","MZ-PCEH17",svr_hardt37552)
	else:
		GS_PS_Exp_Ent_BOM.setAtvQty(Product,"Exp_Ent_Grp_Part_Summary","MZ-PCEH17",0)
	#CXCPQ-37554
	if svr_hardt16gb >0:
		GS_PS_Exp_Ent_BOM.setAtvQty(Product,"Exp_Ent_Grp_Part_Summary","MZ-PCEM49",svr_hardt16gb*2)
	else:
		GS_PS_Exp_Ent_BOM.setAtvQty(Product,"Exp_Ent_Grp_Part_Summary","MZ-PCEM49",0)'''
	#CXCPQ-37553
	if svr_hardt16gb1 >0:
