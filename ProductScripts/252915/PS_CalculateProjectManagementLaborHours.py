...
def getProjectMangementHours():
    ...
    totalfdmHours = getTotalEngHours("MSID_Labor_FDM_Upgrade_Con") if "FDM Upgrade" in selectedProducts else 0
    ...
    totalVirtualizationHours = getTotalEngHours("MSID_Labor_Virtualization_con") if "Virtualization System" in selectedProducts else 0
    totalQCSHours = getTotalEngHours("MSID_Labor_QCS_RAE_Upgrade_con") if "QCS RAE Upgrade" in selectedProducts else 0
    totalGS1Hours = getTotalEngHours("MSID_Labor_Generic_System1_Cont") if "Generic System" in selectedProducts else 0
    totalGS2Hours = getTotalEngHours("MSID_Labor_Generic_System2_Cont") if "Generic System" in selectedProducts else 0
    totalGS3Hours = getTotalEngHours("MSID_Labor_Generic_System3_Cont") if "Generic System" in selectedProducts else 0
    totalGS4Hours = getTotalEngHours("MSID_Labor_Generic_System4_Cont") if "Generic System" in selectedProducts else 0
    totalGS5Hours = getTotalEngHours("MSID_Labor_Generic_System5_Cont") if "Generic System" in selectedProducts else 0
