...
hr = 0
hrs = 0
tableLabor = SqlHelper.GetList('select Product,Container,Deliverable,Calculated_hrs from LABOR_FDS_CALCULATION_HRS')
for row in tableLabor:
    ...
    Product.Attr('Total_FDS_hrs').AssignValue(str(hr))
Trace.Write(hr)