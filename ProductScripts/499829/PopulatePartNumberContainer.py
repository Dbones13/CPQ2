    ...
    try:
        ...
        if queryData1 is not None:
            for entry in queryData1:
                ...
                elif (entry.GES_Part_Number.endswith("_CN") or entry.GES_Part_Number.endswith("_UZ")) and entry.GES_Part_Number not in nonsapCountriesparts:
...
foPartNumberConTrace = getContainer("MSID_Labor_FO_Part_Number_Trace")
...
populateFOPartNumberCon(foPartNumberConTrace,mpaAvailable,activeServiceContract,executionYear)
