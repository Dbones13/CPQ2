if Product.Attr('isProductLoaded').GetValue() == 'True':
    ...
    remove_deliverables = []
    gesloc = Product.Attr('IS_GES_Location').GetValue()
    if gesloc != "None" and gesloc != "":
        deliverables = Product.GetContainerByName('IS_Labor_Container')
        ...
        custom_deliverables = Product.GetContainerByName('IS_Additional_Labor_Container')
