if Product.Attr('isProductLoaded').GetValue() == 'True':
    ...
    remove_deliverables = []
    gesloc = Product.Attr('PAGA_GES_Location')
    if gesloc.GetValue() != "None" and gesloc.GetValue() != "":
        deliverables = Product.GetContainerByName('PAGA_Labor_Container')
        ...
        custom_deliverables = Product.GetContainerByName('PAGA_Additional_Labour_Container')
