import datetime
#PS_PAGA_Labor_Container_Populate
...
if Labor_Site_Activities!= "Yes":
    disallow_lst.append("Site Acceptance Test")
...
tableLabor = SqlHelper.GetList('select Deliverable,Productivity,GES_Eng_1_No,GES_Eng,FO_Eng_1_NoGES,FO_Eng_1_GES_None,FO_Eng_1_GES,FO_Eng_2_NoGES,FO_Eng_2_GES_None,FO_Eng_2_GES,Rank,Calculated_Hrs,Execution_Country from PAGA_LABOR_CUSTOM_TABLE')
...
laborAddi = Product.GetContainerByName('PAGA_Additional_Labour_Container').Rows
...
for row1 in laborAddi:
	...
	row1.Calculate()
Product.GetContainerByName('PAGA_Additional_Labour_Container').Calculate()
