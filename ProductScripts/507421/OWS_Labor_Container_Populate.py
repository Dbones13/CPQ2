import datetime
#PS_One_Wireless_System_Labor_Container_Populate
...
Is_Site_Survey_Required=Product.Attr('Is Site Survey Required').GetValue()
if Is_Site_Survey_Required != "Yes":
    disallow_lst.append("Site Survey and Report")
    
if Labor_Site_Activities != "Yes":
    disallow_lst.append("Pre SAT & Site Acceptance Test")
    disallow_lst.append("On-Site Start-up Support")
...
tableLabor = SqlHelper.GetList('select Deliverable,Productivity,GES_Eng_1_No,GES_Eng,FO_Eng_1_NoGES,FO_Eng_1_GES_None,FO_Eng_1_GES,FO_Eng_2_NoGES,FO_Eng_2_GES_None,FO_Eng_2_GES,Rank,Calculated_Hrs,Execution_Country from ONE_WIRELESS_SYSTEM_LABOR_CUSTOM_TABLE')
...
laborAddi = Product.GetContainerByName('OWS_Additional_Labour_Container').Rows
...
for row1 in laborAddi:
	...
	row1.Calculate()
Product.GetContainerByName('OWS_Additional_Labour_Container').Calculate()
