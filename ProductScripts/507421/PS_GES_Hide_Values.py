if Product.Attr('isProductLoaded').GetValue() == 'True':
    ...
    remove_deliverables = []
    gesloc = Product.Attr('OWS_GES Location')
    if gesloc.GetValue() != "None" and gesloc.GetValue() != "":
        deliverables = Product.GetContainerByName('OWS_Engineering_Labor_Container')
        ...
        custom_deliverables = Product.GetContainerByName('OWS_Additional_Labour_Container')
