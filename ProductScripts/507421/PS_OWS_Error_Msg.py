...
if (('Labor Deliverables' in tabs or 'General Inputs' in tabs) and scope == 'HW/SW + LABOR'):
    ...
    deliverables = Product.GetContainerByName('OWS_Engineering_Labor_Container').Rows
    ...
    if count2 > 0:
        Labor_Message3 = "<b>"+'Cost is not available for selected resource in OneWireless Engineering. Please select different resource or different Execution Country.Deliverables to look into: <br>'+"</b>" + Labor_Message3
        if Labor_Message != "":
    ...
    deliverables = Product.GetContainerByName('OWS_Additional_Labour_Container')
    count = count1 = count2 = 0
    Labor_Message3 = ''
