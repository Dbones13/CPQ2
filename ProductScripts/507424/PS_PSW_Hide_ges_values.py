if Product.Attr('isProductLoaded').GetValue() == 'True':
    ...
    remove_deliverables = []
    gesloc = Product.Attr('PSW_GES_Location').GetValue()
    if gesloc != "None" and gesloc != "":
        deliverables = Product.GetContainerByName('PSW_Labor_Container')
        ...
        custom_deliverables = Product.GetContainerByName('PSW_Additional_Labor_Container')
