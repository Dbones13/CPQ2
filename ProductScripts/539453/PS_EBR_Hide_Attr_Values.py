if Product.Attr('isProductLoaded').GetValue() == 'True':
    ...
    remove_deliverables = ['EBR Procure Materials & Services']
    gesloc = Product.Attr("Experion_HS_Ges_Location_Labour").GetValue()
    if gesloc != "None" and gesloc != "" and Product.Attr("EBR_Software_Required").GetValue()  == 'Yes': 
    #if gesloc != "None" and gesloc != "":
        deliverables = Product.GetContainerByName('EBR_Engineering_Labor_Container')
