...
disallow_lst = [] 
if TagParserProduct.ParseString(Product.Attr("Labor_Site_Activities").GetValue()) != 'Yes':
    disallow_lst.append("Experion HS Site Installation")
    disallow_lst.append("Experion HS Site Acceptance Test & Sign off")

if TagParserProduct.ParseString(Product.Attr("Labor_Operation_Manual_Scope").GetValue()) != 'Yes':
    disallow_lst.append("Experion HS Operation Manual")

if TagParserProduct.ParseString(Product.Attr("Labor_Custom_Scope").GetValue()) != 'Yes':
