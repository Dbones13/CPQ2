if Product.Attr('isProductLoaded').GetValue() == 'True':
    ...
    remove_deliverables = ['SNC Network Assessment Report', 'SNC Engineering Plan', 'SNC Customer Training']
    gesloc = Product.Attr("Experion_HS_Ges_Location_Labour").GetValue()
    if gesloc != "None" and gesloc != "":
        deliverables = Product.GetContainerByName('System_Network_Engineering_Labor_Container')
