import datetime
#System_Network_Labor_Container_Populate
...
if scope == 'HW/SW + LABOR' and Product.Attr('Is System Network Engineering in Scope?').GetValue() == 'Yes':
    ...
    tableLabor = SqlHelper.GetList('select  Deliverable,Productivity,GES_Eng_1,GES_Eng_1_No,GES_Eng,FO_Eng_1_NoGES,FO_Eng_1_GES_None,FO_Eng_1_GES,FO_Eng_2_NoGES,FO_Eng_2_GES_None,FO_Eng_2_GES,Rank,Calculated_Hrs,Execution_Country,FO_Eng_1_LOC_GES from System_Network_ENGINEERING_LABOR')
    ...
    for row in tableLabor:
        if row.Deliverable not in disallow_lst and row.Deliverable not in current_deliverables:
            ...
            if gesLocation == "None" or gesLocation == '':
                ...
                if row.FO_Eng_1_LOC_GES: #FO_Eng_1_LOC_GES represents FO Eng 1 when GES location is selected
                ...
                if row.Deliverable in ['SNC Engineering Plan']:
                    new_row['GES Eng'] = ''
                else:
                ...
                if row.Deliverable == cont_row.GetColumnByName('Deliverable').Value:
                    ...
                    if cont_row['GES Location'] != gesLocationVC:
                        ...
                        if gesLocation == "None" or gesLocation == '':
                            ...
                            if row.Deliverable in ['SNC Customer Training', 'SNC Engineering Plan', 'SNC Network Assessment Report']:
                                cont_row['GES Eng'] = ''
                            else:
