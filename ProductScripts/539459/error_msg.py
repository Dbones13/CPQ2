...
if (('Labor Deliverables' in tabs or 'General Inputs' in tabs) and scope == 'HW/SW + LABOR'):
    ...
    #Error Message for SM Safety System - ESD/FGS/BMS/HIPPS Container
    deliverables = Product.GetContainerByName('SM Safety System - ESD/FGS/BMS/HIPPS Container').Rows
