...
if 'Labor Deliverables' in tabs:
    years_list = Product.Attr('CE UOC Engineering Execution Year').Values
    ...
    if allowed_count > expected_count:
        ...
        max_year = 2037
        for attribute_name in ['CE UOC Engineering Execution Year', 'UOC_CD_LD_Engineering_Execution Year']:
