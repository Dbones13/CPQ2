if Product.Attr('isProductLoaded').GetValue() == 'True':
    ...
    if gesloc.GetValue() != "None" and gesloc.GetValue() != "":
        deliverables = Product.GetContainerByName('eServer_Labor_Container')
        ...
        custom_deliverables = Product.GetContainerByName('eServer_Labor_Additional_Cust_Deliverables_con')
