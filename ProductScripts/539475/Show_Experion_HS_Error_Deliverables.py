...
if (('Labor Deliverables' in tabs or 'General Inputs' in tabs) and scope == 'HW/SW + LABOR'):
    ...
    #Error Message for Experion HS Engineering Labor Container
    deliverables = Product.GetContainerByName('Experion HS Engineering Labor Container').Rows
    ...
    if count2 > 0:
        Labor_Message3 = "<b>"+'Cost is not available for selected resource inExperion HS Engineering Labor Container. Please select different resource or different Execution Country.Deliverables to look into: <br>'+"</b>" + Labor_Message3
        if Labor_Message != "":
            Labor_Message += "<br>" + Labor_Message3
        else:
            Labor_Message = Labor_Message3

    #Error Message for Experion HS Additional Custom Deliverables
    Experion_Error_Message_val = Experion_Error_Message_val2 = ""
    deliverables = Product.GetContainerByName('Experion HS Additional Custom Deliverables')
    count = count1 = count2 = 0
    Labor_Message3 = ''
