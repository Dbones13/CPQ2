...
gesloc = Product.Attr('FDM_GES_Location')
if gesloc.GetValue() != "None" and gesloc.GetValue() != "":
    deliverables = Product.GetContainerByName('FDM Engineering Labor Container')
    ...
    custom_deliverables = Product.GetContainerByName('FDM Additional Custom Deliverables')
