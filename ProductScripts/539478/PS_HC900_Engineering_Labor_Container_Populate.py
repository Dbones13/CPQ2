...
if scope == 'HW/SW + LABOR':
    ...
    if Product.Attr("Labor_Site_Activities").GetValue() != 'Yes':
        disallow_lst.append("HC900 Site Installation")
        disallow_lst.append("HC900 Site Acceptance Test & Sign off")

    if Product.Attr("Labor_Operation_Manual_Scope").GetValue() != 'Yes':
        disallow_lst.append("HC900 Operation Manual")

    if Product.Attr("Labor_Custom_Scope").GetValue() != 'Yes':
        disallow_lst.append("HC900 Customer Training")

    if Product.Attr("CE_Cutover").GetValue() != 'Yes':
        disallow_lst.append("HC900 Cut Over Procedure ")
    ...
    laborAddi = Product.GetContainerByName('HC900 Additional Custom Deliverables').Rows
