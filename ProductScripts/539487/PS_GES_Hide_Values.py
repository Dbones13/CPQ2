if Product.Attr('isProductLoaded').GetValue() == 'True':
    ...
    remove_deliverables = []
    gesloc = Product.Attr('PRMS GES Location')
    if gesloc.GetValue() != "None" and gesloc.GetValue() != "":
        deliverables = Product.GetContainerByName('PRMS_Engineering_Labor_Container')
        ...
        custom_deliverables = Product.GetContainerByName('PRMS_Additional_Labor_Container')
