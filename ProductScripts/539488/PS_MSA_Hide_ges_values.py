...
gesloc = Product.Attr('MSASE_GES_Location')
if gesloc.GetValue() != "None" and gesloc.GetValue() != "":
    deliverables = Product.GetContainerByName('MS_ASE_Engineering_Labor_Container')
    ...
    custom_deliverables = Product.GetContainerByName('MS_ASE_Additional_Labour_Container')
