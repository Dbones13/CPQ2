import datetime
#PS_MS_Analyser_System_Engineering_Labor_Container_Populate
...
laborCont = Product.GetContainerByName('MS_ASE_Engineering_Labor_Container')
tableLabor = SqlHelper.GetList('select Deliverable,Productivity,GES_Eng_1_No,GES_Eng,FO_Eng_1_NoGES,FO_Eng_1_GES_None,FO_Eng_1_GES,FO_Eng_2_NoGES,FO_Eng_2_GES_None,FO_Eng_2_GES,Rank,Calculated_Hrs,Execution_Country from MS_ANALYSER_SYSTEM_ENGINEERING_LABOR_CUSTOM_TABLE')
...
laborAddi = Product.GetContainerByName('MS_ASE_Additional_Labour_Container').Rows
...
for row1 in laborAddi:
	...
	row1.Calculate()
Product.GetContainerByName('MS_ASE_Additional_Labour_Container').Calculate()
