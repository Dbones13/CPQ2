...
if 'Labor Deliverables' in tabs:
    years_list = Product.Attr('Experion_mx_Labor_Execution_Year').Values
    ...
    if allowed_count > expected_count:
        ...
        max_year = 2037
        for attribute_name in ['Experion_mx_Labor_Execution_Year', 'Experion_mx_Labor_Execution_Year_adc']:
