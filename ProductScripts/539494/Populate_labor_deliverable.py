...
if scope == 'HW/SW + LABOR':
    ...
    if process_type != "Yes":
        disallow_lst.append("MXProLine Site Installation")
        disallow_lst.append("MXProLine Site Acceptance Test & Sign off")
    process_type1 = Product.Attr('Labor_Operation_Manual_Scope').GetValue()
    if process_type1 != "Yes":
        disallow_lst.append("MXProLine Operation Manual")
    process_type2 = Product.Attr('Labor_Custom_Scope').GetValue()
    if process_type2 != "Yes":
        disallow_lst.append("MXProLine Customer Training")
    process_type3 = Product.Attr('CE_Cutover').GetValue()
    if process_type3 != "Yes":
        disallow_lst.append("MXProLine Cut Over Procedure")
    ...
    laborAddi = Product.GetContainerByName('MXPro_Labor_Additional_Cust_Deliverables_con').Rows
