if Product.Attr('isProductLoaded').GetValue() == 'True':
    specific_location = {'GES China': ['HPS_GES_P335B_CN','HPS_GES_P335F_CN','HPS_GES_P350B_CN','HPS_GES_P350F_CN'], 'GES India': ['HPS_GES_P335B_IN','HPS_GES_P335F_IN','HPS_GES_P350B_IN','HPS_GES_P350F_IN'], 'GES Romania':['HPS_GES_P335B_RO','HPS_GES_P335F_RO','HPS_GES_P350B_RO','HPS_GES_P350F_RO'], 'GES Uzbekistan':['HPS_GES_P335B_UZ','HPS_GES_P335F_UZ','HPS_GES_P350B_UZ','HPS_GES_P350F_UZ'], 'GES Egypt':['HPS_GES_P350B_EG','HPS_GES_P350F_EG','HPS_GES_P335B_EG','HPS_GES_P335F_EG']}
    ...
    remove_deliverables = []
    gesloc = Product.Attr('FDA GES Location').GetValue()
    if gesloc != "None" and gesloc != "":
        deliverables = Product.GetContainerByName('FDA_Engineering_Labor_Container')
        ...
        custom_deliverables = Product.GetContainerByName('FDA_Additional_Labor_Container')
