sm_cont_rows = Product.GetContainerByName('SM_RG_PartSummary_Cont').Rows
...
if errorFlag:
    ...
    #Product.Messages.Clear()
    sm_cont_rows = Product.GetContainerByName('SM_RG_PartSummary_Cont').Rows
    sm_li_cont = Product.GetContainerByName('SM_RG_PartSummary_LI_Cont')
