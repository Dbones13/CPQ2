...
if not isR2Qquote:
        ...
        if row['Selected_Products'] == 'OPM':
            ...
            for key in parameters:
                if key == "MSID_CommonQuestions":
                    ...
                    Trace.Write("ressScope"+str(ressScope))
                    Var_24 = 0
                    Var_31 = getRowData(product,key,parameters[key]["Var_31"])
                    if ressScope == "Yes":
                        Var_24 = 1
                    elif ressScope == "No":
                        Trace.Write("ressscope")
                        Var_24 = 0
                        Trace.Write("ressscope"+str(Var_24))
    ...
    def calculate_smallSystem(Var_1, Var_3, Var_4, Var_7, Var_8, Var_27, Var_24):
        ...
        Trace.Write("ressScope_1"+str(ressScope))
    ...
    if 'OPM' in selectedProducts:
        ...
        if eac_per > 0 and amt == 'Yes':
            ...
            Product.GetContainerByName('OPM_LaborAMT_Details').Rows.Clear()
