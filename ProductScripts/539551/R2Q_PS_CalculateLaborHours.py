...
if isR2Qquote:
	...
	for MigrationNew in migration_new_cont.Rows:
		...
		msidContainer = MigrationNew.Product.GetContainerByName("MSID_Labor_TPS_TO_EXPERION_Con")
		for row in msidContainer.Rows:
			Trace.Write("LM Labor Data"+row['Deliverable']+"Calculated_Hrs"+row['Calculated_Hrs'])