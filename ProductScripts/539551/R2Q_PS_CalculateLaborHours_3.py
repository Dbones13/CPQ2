			...
			if row['Selected_Products'] == 'OPM':
				...
				for key in parameters:
					if key == "MSID_CommonQuestions":
						Var_22 = getAttrData(MigrationNew.Product,parameters[key]["Var_22"])
						Var_5 = getAttrData(MigrationNew.Product,parameters[key]["Var_5"])
						Var_6 = getAttrData(MigrationNew.Product,parameters[key]["Var_6"])
				...
				if opmEngineeringCon.Rows.Count > 0:
					for row in opmEngineeringCon.Rows:
						...
						if row["Deliverable"] == "OPM Plan Review & Migration Registration KOM":
							...
							Trace.Write("Var_1"+str(Var_1)+"Var_2"+str(Var_2)+"Var_3"+str(Var_3)+"Var_4"+str(Var_4)+"Var_7"+str(Var_7)+"Var_8"+str(Var_8)+"Var_9"+str(Var_9)+"Var_10"+str(Var_10)+"Var_21"+str(Var_21)+"Var_23"+str(Var_23)+"Var_24"+str(Var_24)+"Var_27"+str(Var_27)+"Var_28"+str(Var_28)+"Var_29"+str(Var_29)+"Var_31"+str(Var_31)+"Var_6"+str(Var_6)+"Var_5"+str(Var_5))
