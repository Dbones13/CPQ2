if Product.Attr('isProductLoaded').GetValue() == 'True':
    ...
    remove_deliverables = []
    gesloc = Product.Attr('GAS MeterSuite GES Location')
    if gesloc.GetValue() != "None" and gesloc.GetValue() != "":
        deliverables = Product.GetContainerByName('Gas_MeterSuite_Engineering_Labor_Container')
        ...
        custom_deliverables = Product.GetContainerByName('Gas_MeterSuite_Additional_Labor_Container')
