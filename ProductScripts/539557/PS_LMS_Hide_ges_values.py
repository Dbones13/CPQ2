...
gesloc = Product.Attr('LMS_GES_Location')
if gesloc.GetValue() != "None" and gesloc.GetValue() != "":
    deliverables = Product.GetContainerByName('LMS_Labor_Container')
    ...
    custom_deliverables = Product.GetContainerByName('LMS_Additional_Labor_Container')
