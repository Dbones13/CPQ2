...
tableLabor = SqlHelper.GetList('select Deliverable,Productivity,GES_Eng_1_No,GES_Eng,FO_Eng_1_NoGES,FO_Eng_1_GES_None,FO_Eng_1_GES,FO_Eng_2_NoGES,FO_Eng_2_GES_None,FO_Eng_2_GES,Rank,Calculated_Hrs,Execution_Country from LIQUID_METERINGSUITE_ENGINEERING_LABOR_CUSTOM_TABLE')
...
laborAddi = Product.GetContainerByName('LMS_Additional_Labor_Container').Rows
...
for row1 in laborAddi:
	...
	row1.Calculate()
Product.GetContainerByName('LMS_Additional_Labor_Container').Calculate()
