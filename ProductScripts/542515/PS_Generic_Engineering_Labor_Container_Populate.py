...
if scope == 'HW/SW + LABOR':
    ...
    if Product.Attr("Labor_Site_Activities").GetValue() != 'Yes':
        disallow_lst.append("Generic Site Installation")
        disallow_lst.append("Generic Site Acceptance Test & Sign off")

    if Product.Attr("Labor_Operation_Manual_Scope").GetValue() != 'Yes':
        disallow_lst.append("Generic Operation Manual")

    if Product.Attr("Labor_Custom_Scope").GetValue() != 'Yes':
        disallow_lst.append("Generic Customer Training")

    if Product.Attr("CE_Cutover").GetValue() != 'Yes':
        disallow_lst.append("Generic Cut Over Procedure")
    ...
    laborAddi = Product.GetContainerByName('Generic Additional Custom Deliverables').Rows
