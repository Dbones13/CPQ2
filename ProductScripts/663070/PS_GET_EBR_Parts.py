if Product.Attr('PERF_ExecuteScripts').GetValue() != '':
    ...
    #CXCPQ-46574
    Log.Info('EBR Parts --- '+str(qnt)+' -- Experion Backup Restore Software Release---'+str(Product.Attributes.GetByName("Experion Backup Restore Software Release").GetValue()))
